    ...
    const task = this.http.get<{ message: string, data: number }>(`${BACKEND_URL}` + route)
      ...
      .pipe(delay(100),
        concatMap(() => {
          return of(this.addMockPost(nextPostCount++, {
            category: 'world',
            imageUrl: 'https://storage.googleapis.com/thenewsroom-images-storage-bucket/1568126020447_donald-trump-putin-helsinki.jpeg'
          }));
        })
      )
      .pipe(delay(100),
        concatMap(() => {
          return of(this.addMockPost(nextPostCount++, {
            ...
            imageUrl: 'https://storage.googleapis.com/thenewsroom-images-storage-bucket/1568125671511_lionel-messi.jpeg'
          }));
        })
      )
      .pipe(delay(100),
      ...
      .pipe(delay(100),
        concatMap(() => {
          return of(this.addMockPost(nextPostCount++, {
            ...
            imageUrl: 'https://storage.googleapis.com/thenewsroom-images-storage-bucket/1568125382683_u2.jpeg'
          }));
        })
      )
      .pipe(delay(100),
        concatMap(() => {
          return of(this.addMockPost(nextPostCount++, {
            ...
            imageUrl: 'https://storage.googleapis.com/thenewsroom-images-storage-bucket/1568124093683_truedetective.jpeg'
          }));
        })
      )
      .pipe(delay(100),
